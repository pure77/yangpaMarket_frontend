...
## 하네스: yangpaMarket 프론트엔드 개발

**목표:** 경매 마켓플레이스 프론트엔드의 기능 구현/수정/버그 수정/API 연동 작업을 에이전트 팀으로 자동화

**트리거:** 구현, 수정, 추가, 버그 수정, API 연동 등 개발 작업 요청 시 `yangpa-dev` 스킬을 사용하라. 단순 질문은 직접 응답 가능.
